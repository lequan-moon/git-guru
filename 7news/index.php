 ...
 */
define('APPPATH', realpath(__DIR__.'/../configure_7news/app/').DIRECTORY_SEPARATOR);

/**
 * Path to the default packages directory.
 */
define('PKGPATH', realpath(__DIR__.'/../configure_7news/packages/').DIRECTORY_SEPARATOR);

/**
 * The path to the framework core.
 */
define('COREPATH', realpath(__DIR__.'/../configure_7news/core/').DIRECTORY_SEPARATOR);
